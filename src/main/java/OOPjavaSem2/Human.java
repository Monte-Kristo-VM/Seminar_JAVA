...
abstract class Human implements FamilyTree, FamilyTies{
    ...
    public void Children(ArrayList list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (this.FIO.equals(((OOPjavaSem2.Human) (list.get(i))).fatherFIO)&
                    this.birthday.equals(((OOPjavaSem2.Human) (list.get(i))).fatherBirthday)|
                    this.FIO.equals(((OOPjavaSem2.Human) (list.get(i))).motherFIO)&
                            this.birthday.equals(((OOPjavaSem2.Human) (list.get(i))).motherBirthday)) {
                System.out.println(((OOPjavaSem2.Human) (list.get(i))).FIO);
                count++;
            }
        }
        if (count == 0){
