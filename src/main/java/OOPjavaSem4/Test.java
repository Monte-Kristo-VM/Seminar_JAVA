...
public class Test {
    public static void main(String[] args) {
        ...
        Birthday birthdayMan1;
        birthdayMan1 = () -> man1.birthday;
        System.out.println(birthdayMan1.printBirthday());

        Address addressInt = new Address<>("Нижний Тагил", "Ленина", 23, 5);
        addressInt.showAddress();

        Address addressStr = new Address<>("Нижний Тагил", "Ленина", "23", "5");
        addressStr.showAddress();
